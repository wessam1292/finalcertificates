...
public class Popip2 {
    ...
    WebDriver driver;
    public String filepath = System.getProperty("user.dir")+"//Upload//newprivatecert.xlsx";
    ...
    public void start () throws InterruptedException {
        ...
        driver.manage().timeouts().implicitlyWait(120, TimeUnit.SECONDS);
            ...
            driver.get("https://wessam.gamal1@vodafone.com:Maha123456@enrol.pki.vodafone.com/aspx/certificate/CertificateIssuancePkcs10View.aspx");
            Thread.sleep(5000);
...
@Test(dataProvider = "newdata")
        ...
        public void wessam ( String csrname) throws InterruptedException, AWTException {



        //String csrname = "cfs-portal-adm.vodafone.com.csr";
        String csrpath = System.getProperty("user.dir")+"\\privateupload\\"+csrname;
